...
//     bookmarkItems,
//     deleteBookmarkItem,
//   } = useCartBookmark('bookmark');

//   const notification = useNotification();
//   const [selectedItems, setSelectedItems] = useState<string[]>([]);
//   const [selectAll, setSelectAll] = useState<boolean>(true);
//   const navigate = useNavigate();
//   const productIds = bookmarkItems.map((item) => item.productId);
//   const productImages = useProductImageBatch(productIds);

//   useEffect(() => {
//     if (isOpen && bookmarkItems.length > 0) {
//       const allItemIds = bookmarkItems.map((item) => item.id);
...
//     setSelectedItems(selectAll ? [] : bookmarkItems.map((item) => item.id));
//   };
...
//                   {/* 상품 이미지 */}
//                   <img
//                     src={productImages[item.productId] || '/default-product.png'}
