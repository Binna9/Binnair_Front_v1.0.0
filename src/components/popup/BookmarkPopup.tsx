  ...
  return (
    ...
    >
      ...
      >
        ...
        {!isLoggedIn ? (
          <div className="flex-1 py-12 text-center flex flex-col items-center justify-center gap-10">
            <p className="text-gray-700 font-medium">
              로그인 후 즐겨찾기 기능 사용 가능합니다.
            </p>  
          </div>
        ) : (
          <>
            ...
            <div className="flex-1 overflow-y-auto space-y-3 custom-scroll p-3">
              {bookmarkItems.length > 0 ? (
                ...
                <p className="text-gray-500 text-center">즐겨찾기가 없습니다.</p>
              )}
            </div>
          </>
        )}
