  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 w-full h-12 bg-zinc-900/90 backdrop-blur-md shadow-md flex items-center justify-between px-4 z-50">
        ...
        <div className="flex items-center w-[400px]"> 
          <div className="relative w-full transition-transform duration-200 hover:scale-105">
            ...
            <Input
              type="text"
              placeholder="Search ..."
              className="pl-10 pr-3 py-1.5 bg-white/20 text-white/90 placeholder-white/70 rounded-full shadow-lg 
        ...
        {/* ✅ 로그인 여부에 따른 UI 변경 */}
        <div className="flex items-center w-[240px] ml-20">
          {user ? (
            <div
              className="flex items-center space-x-2 w-full bg-white/10 backdrop-blur-md py-1 px-1.5 rounded-lg border border-white/20 
            ...
            >
              ...
              <div className="relative group">
                ...
                <img
                  ...
                  alt="Profile"
                  className="relative w-8 h-8 rounded-full border-2 border-white/80 shadow-lg cursor-pointer transition-all duration-300 hover:scale-110 hover:border-purple-400"
              ...
              <div className="flex flex-col">
                <div className="flex items-center space-x-1">
                  <span
                    className="text-sm font-bold text-white cursor-pointer truncate max-w-[80px] whitespace-nowrap 
        ...
        {/* ✅ 우측 설정 버튼들 */}
        <div className="flex items-center gap-2 w-[200px] ml-2">
          {user ? (
            <>
              {/* ✅ 프로필 버튼 */}
              <Button
            ...
            <div className="flex items-center justify-start w-full pl-2">
              <div className="relative group">
                ...
                <div className="relative px-4 py-1.5 bg-black/20 backdrop-blur-sm rounded-lg border border-white/10">
