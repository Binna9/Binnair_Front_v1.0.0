...
import { UserResponse, UserPasswordChangeRequest, UserUpdateRequest } from './../../types/UserTypes';
...
export const useProfile = (userId: string | null) => {
  ...
  // ✅ 사용자 수정
  const updateUser = async (userId: string ,userUpdateRequest: UserUpdateRequest) => {
    try {
